...
1.  **Make sure you have Gatsby installed.**
    ...
    You can follow instructions [in the Gatsby core repo](https://github.com/gatsbyjs/gatsby#-get-up-and-running-in-5-minutes).
...
4.  **Open the source code and start editing!**
    ...
    Open the `wpcampus-gatsby-theme` directory in your code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
