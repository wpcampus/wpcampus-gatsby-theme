...
const WPCampusLogo = ({ includeTagline }) => {
	...
	return (
		<div className="wpc-logo">
			<svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox={`0 0 300 ${height}`}>
				<title>{title}</title>
				<g>
					<g>
				...
				{includeTagline ? <WPCampusLogoTagline /> : null}
			</svg>
		</div >
	)
}

WPCampusLogo.propTypes = {
	includeTagline: PropTypes.bool
}

WPCampusLogo.defaultProps = {
	includeTagline: true
}
